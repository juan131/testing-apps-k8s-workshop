...
curl -Lo kubectl "https://storage.googleapis.com/kubernetes-release/release/${stable_kubectl_version}/bin/linux/amd64/kubectl"
chmod +x ./kubectl
...
tar xfv helm-v2.11.0-linux-amd64.tar.gz
